...
import com.gdu.mini.base.operateFactory.AppOperate;
import com.gdu.mini.base.operateFactory.IosOperate;
import com.gdu.mini.business.Login;
import com.gdu.mini.utils.Sleep;
import com.gdu.mini.base.operateFactory.AndroidOperate;
...
//		}
		Sleep.sleep(3);
			if (platformName.toLowerCase().contains("android"))
			{
				((AppiumDriver) driver).removeApp("com.gdu.phonedrone");
			}else
			{
				((AppiumDriver) driver).removeApp("com.guideuav.gdumini");
			}
